...
public class gedanlistviewlikeadapter  extends BaseAdapter{
	  ...
	  public gedanlistviewlikeadapter(){
		  
	  }
	   public  gedanlistviewlikeadapter(Context context,List<HashMap<String,Object>> hhh){
		       super();
		       this.transit = hhh;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		 if(convertView == null){
			   convertView = inflater.inflate(R.layout.wholegedan1, null);
			   geming = (TextView)convertView.findViewById(R.id.showgeming1);
			   geshou = (TextView)convertView.findViewById(R.id.showgeshou1);
		 }
		 else{}
		 //返回数据
